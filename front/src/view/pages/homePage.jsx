	...
	return (
		<div id="home" className="container">
			<div className="content">
				...
				<p>
					PrimeCode Academy allows you to learn
					programming languages from the comfort
					of your own home. Weather your goal is
					to become a full-stack developer or just
					learn the basics, we have a course for
					you.
				</p>

				<h3>Migrate to Language:</h3>

				<Link className="button-action" to={"/compare"}>
					Migrate
				</Link>
