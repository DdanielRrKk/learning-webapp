...
export default function LanguageComparePage() {
	const [conceptArray, setConceptArray] =
		React.useState(MigrationConcept);
	const [firstLanguageArrays, setFirstLanguageArrays] =
		React.useState(MigrationJavaScript);
	const [secondLanguageArrays, setSecondLanguageArrays] =
		React.useState(MigrationPython);
	...
	return (
		<div id="language-compare" className="container">
